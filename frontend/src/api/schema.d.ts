export interface paths {
    ...
    "/api/setup": {
        ...
        /**
         * Get Setup Status
         * @description 初回セットアップの状態(モデルが揃っているか)
         */
        get: operations["get_setup_status_api_setup_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/setup/{item}": {
        ...
        /**
         * Start Setup
         * @description モデル取得を始める。進捗は既存のジョブAPI(SSE)で受け取る
         */
        post: operations["start_setup_api_setup__item__post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/license": {
        ...
        /** Get License */
        get: operations["get_license_api_license_get"];
        put?: never;
        /** Register License */
        post: operations["register_license_api_license_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/keys/{provider}": {
        ...
        get?: never;
        /** Register Key */
        put: operations["register_key_api_keys__provider__put"];
        post?: never;
        /** Delete Key */
...
export interface operations {
    ...
    get_setup_status_api_setup_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    start_setup_api_setup__item__post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    register_license_api_license_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["LicenseRegistration"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    register_key_api_keys__provider__put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["KeyRegistration"];
            };
        };
        responses: {
            /** @description Successful Response */
